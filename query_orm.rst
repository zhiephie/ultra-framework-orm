...
All Idiorm queries start with a call to the ``table`` static method
...
.. code-block:: php
    ...
    $person = ORM::table('person')->where('name', 'Fred Bloggs')->find_one();
...
.. code-block:: php
    ...
    <?php
    $person = ORM::table('person')->find_one(5);
...
.. code-block:: php
    ...
    <?php
    $person = ORM::table('user_role')->find_one(array(
        'user_id' => 34,
        'role_id' => 10
    ));
...
.. code-block:: php
    ...
    <?php
    $people = ORM::table('person')->find_many();
...
.. code-block:: php
    ...
    <?php
    $females = ORM::table('person')->where('gender', 'female')->find_many();
...
.. code-block:: php
    ...
    <?php
    ORM::table('person')->find_result_set()
    ->set('age', 50)
    ->save();
...
.. code-block:: php
    ...
    <?php
    foreach(ORM::table('person')->find_result_set() as $record) {
        echo $record->name;
    }
...
.. code-block:: php
    ...
    <?php
    echo count(ORM::table('person')->find_result_set());
...
.. code-block:: php
    ...
    <?php
    $females = ORM::table('person')->where('gender', 'female')->find_array();
...
.. code-block:: php
    ...
    <?php
    $number_of_people = ORM::table('person')->count();
...
-  Less than:
   ``$people = ORM::table('person')->where_lt('age', 10)->find_many();``
-  Greater than:
   ``$people = ORM::table('person')->where_gt('age', 5)->find_many();``
-  Less than or equal:
   ``$people = ORM::table('person')->where_lte('age', 10)->find_many();``
-  Greater than or equal:
   ``$people = ORM::table('person')->where_gte('age', 5)->find_many();``
...
.. code-block:: php
    ...
    <?php
    $people = ORM::table('person')->where_like('name', '%fred%')->find_many();
...
.. code-block:: php
    ...
    <?php
    $people = ORM::table('person')->where_not_like('name', '%bob%')->find_many();
...
.. code-block:: php
    ...
    <?php
    $people = ORM::table('person')->where_in('name', array('Fred', 'Joe', 'John'))->find_many();
...
.. code-block:: php
    ...
    <?php
    $people = ORM::table('person')->where('gender', 'female')->limit(5)->offset(10)->find_many();
...
.. code-block:: php
    ...
    <?php
    $people = ORM::table('person')->order_by_asc('gender')->order_by_desc('name')->find_many();
...
.. code-block:: php
    ...
    <?php
    $people = ORM::table('person')->order_by_expr('SOUNDEX(`name`)')->find_many();
...
.. code-block:: php
    ...
    <?php
    $people = ORM::table('person')->where('gender', 'female')->group_by('name')->find_many();
...
.. code-block:: php
    ...
    <?php
    $people = ORM::table('person')->where('gender', 'female')->group_by_expr("FROM_UNIXTIME(`time`, '%Y-%m')")->find_many();
...
.. code-block:: php
    ...
    <?php
    $people = ORM::table('person')->group_by('name')->having_not_like('name', '%bob%')->find_many();
...
.. code-block:: php
    ...
    <?php
    $people = ORM::table('person')->select('name')->select('age')->find_many();
...
.. code-block:: php
    ...
    <?php
    $people = ORM::table('person')->select('name', 'person_name')->find_many();
...
.. code-block:: php
    ...
    <?php
    $people = ORM::table('person')->select('person.name', 'person_name')->find_many();
...
.. code-block:: php
    ...
    $people_count = ORM::table('person')->select_expr('COUNT(*)', 'count')->find_many();
...
.. code-block:: php
    ...
    <?php
    $people = ORM::table('person')->select_many('name', 'age')->find_many();
...
.. code-block:: php
    ...
    <?php
    $people = ORM::table('person')->select_many(array('first_name' => 'name'), 'age', 'height')->find_many();
...
.. code-block:: php
    ...
    <?php
    $people = ORM::table('person')->select_many('name', 'age', 'height')->select_expr('NOW()', 'timestamp')->find_many();
...
.. code-block:: php
    ...
    <?php
    $distinct_names = ORM::table('person')->distinct()->select('name')->find_many();
...
.. code-block:: php
    ...
    <?php
    $results = ORM::table('person')->join('person_profile', array('person.id', '=', 'person_profile.person_id'))->find_many();
...
.. code-block:: php
    ...
    $results = ORM::table('person')->join('person_profile', 'person.id = person_profile.person_id')->find_many();
...
.. code-block:: php
    ...
    <?php
    $min = ORM::table('person')->min('height');
...
.. code-block:: php
    ...
    <?php
    $people = ORM::table('person')->raw_query('SELECT p.* FROM person p JOIN role r ON p.role_id = r.id WHERE r.name = :role', array('role' => 'janitor'))->find_many();

The ORM class instance(s) returned will contain data for all the columns
returned by the query. Note that you still must call ``table`` to
