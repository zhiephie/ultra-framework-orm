<?php defined('APP') OR exit('No direct script access allowed');
     ...
     * All rights reserved.
     *
     * Edited and Custom by Yudi Purwanto
     * 27-juni-2014
     *
     */
    ...
    class ORM implements ArrayAccess {
         ...
         * ORM::table('table_name')->find_one()-> etc. As such,
        ...
        */
        ...
        protected function _create_instance_from_row($row) {
            $instance = self::table($this->_table_name, $this->_connection_name);
    ...
    class IdiormResultSet implements Countable, IteratorAggregate, ArrayAccess, Serializable {
         ...
         * @example ORM::table('Widget')->find_many()->set('field', 'value')->save();
         * @param string $method
         * @param array $params
         * @return \IdiormResultSet
         */
